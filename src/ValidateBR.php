...
{
    /**
     * Validate CEP (C�digo de Endere�amento Postal, like postcode in US
     * and other languages)
    ...
    public function cep($cod){
         return (bool) preg_match('/^([0-9]{2}\.?[0-9]{3})[- ]?([0-9]{3})$/', addcslashes($cod, "\n"));
    }
    ...
    /**
     * Validade CNPJ (Cadastro Nacional de Pessoa Jur�dica)
     *
    ...
    public function renavam($renavam){
        if(is_numeric($renavam)){
            ...
            $array = array(000000000,111111111,222222222,333333333,444444444,555555555,666666666,777777777,888888888,999999999);
            if(in_array($renavam, $array)){
                return false;
            }    
    ...
    public function placaDeCarro($placa){
        if(preg_match('/\w{3}-\d{4}/', trim($placa))){
            return true;
        }
